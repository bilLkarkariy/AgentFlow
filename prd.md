...
## 1. Introduction et Vue d’Ensemble  
AgentFlow PME est une plateforme SaaS **hybride** combinant low‑code/no‑code et orchestration d’**AI multi‑agents** pour permettre aux PME européennes de créer et exécuter des automatisations complexes (facturation, support, conformité) sans écrire de code.  
...
### 1.2 Vision  
Démocratiser l’automatisation intelligente : apporter la puissance des agents IA collaboratifs dans une interface low‑code simple, souveraine et abordable, afin de libérer 30 % du temps opérationnel des PME.  
...
* PME européennes (1‑249 salariés), secteurs : finance, services, industrie légère.
...
| **FR‑02** | Studio de configuration LCNC | NL + éditeur drag‑and‑drop, Blocks Agents IA, test, logs |
...
| **FR‑12** | Blocks Agents IA (beta_agents) | Modules AI multi-agents en version bêta |
...
| **Q4 2025** | Beta Blocks Agents IA + GA Plan Élite, White‑label cabinets | Innovation & acquisition |
